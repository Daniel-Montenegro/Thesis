...
Mass_halo= sub.SubhaloMass[:Size_data]*1e10/0.7 
...
cos_beta = np.reshape(cos_beta,(3,len(r_bh)))    
...
print("tamano mass_halo=",(len(Mass_halo)))
...
"""
plt.figure()
plt.hist(cos_theta_bh[0])
plt.xlabel("$\cos(\Theta)$")
plt.savefig("histo_cos_theta.png")
