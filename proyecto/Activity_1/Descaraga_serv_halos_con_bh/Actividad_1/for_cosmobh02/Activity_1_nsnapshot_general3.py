...
#hist_Mass_halo=np.histogram(np.log10(Mass_halo), bins=17)
plt.figure()
plt.hist(np.log10(Mass_bh),bins=5, log=True)
...
print(len(cos_theta_halo[0]),len(Mass_halo))

plt.figure()
plt.plot(np.log10(Mass_halo),cos_theta_halo[0],'.', label='Eigen_1')
plt.plot(np.log10(Mass_halo),cos_theta_halo[1],'.', label='Eigen_2')
plt.plot(np.log10(Mass_halo),cos_theta_halo[2],'.', label='Eigen_3')
