...
print("En cosmobh02")
#DataFolder = "/home/dmontenegro/Data/Sims512/"
#simulation = "cosmobh02/"
#File = "fof_subhalo_tab_015.0.hdf5"
#sub = gadget.Subfind("%s%s%s"%(DataFolder,simulation,File) ,combineFiles=True)
